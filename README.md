...
The repo [to be defined] associated with conducting MOE will be used to source the most up to date code for this project.  Potential comparisons to this method are slim, because MOE uses a matrix as a response.  PERMANOVA is one for sure however.
